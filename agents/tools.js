...
var Tools = (function() {
  ...
  // ─── Keyword routing ─────────────────────────────────────
  var KEYWORDS = {
    about:   ['who','emin','gench','bio','work','job','role','career','background','experience','yourself','cresta','title','company','position','education','degree','aerospace','fde','resume','cv','history','past','worked','studied','teams','team','lead','led','manage','managed','shipped','launched','delivered','vancouver','location','living','based','school','university','website','site','made','built','opportunities','available','employer','works','where does he','what does he','who does he','whats his','his job','his role','his work','does he','study','where did he'],
  ...
  var TOOL_REGISTRY = [
    { name: 'about', fn: tool_about, description: 'Emin Gench biography, career, current role at Cresta AI', keywords: ['emin','gench','bio','work','job','role','career','background','experience','yourself','cresta','title','company','position','education','degree','aerospace','fde','resume','cv','teams','team','lead','led','manage','managed','shipped','launched','delivered','vancouver','location','live','living','based','school','university','website','site','made','built','opportunities','available','employer','works','where does he','what does he','who does he','whats his','his job','his role','his work','does he'], scopeWords: ['emin','gench','career','role','job','work','background','experience','cresta','engineer','title','position','education','aerospace','fde','vancouver','team','lead','manage','launched','school','employer','his','company','based','living','location','degree','cv','resume','university','study','worked','studied','past','history','built','build','made','opportunities','available','shipped','delivered','what does he','where does he','who does he','whats his','does he','his job','his role','his work','yourself','bio','website','site','what did he'], selfContained: true, category: 'discover', params: {} },
