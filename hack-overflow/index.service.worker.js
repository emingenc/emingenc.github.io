...
/** @type {string} */
const CACHE_VERSION = '1787457602|1972455';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["index.html","index-c2b873c3.js","index.offline.html","index.icon.png","index.apple-touch-icon.png","index.audio.worklet.js","index.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["index-c2b873c3.wasm","index-c2b873c3.pck"];
