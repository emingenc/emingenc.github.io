...
export default Vue.extend({
  ...
  head() {
    ...
    const href = `https://eminegnc.github.io${this.$route?.path}`
  ...
  computed: {
    ...
    getPostImage(): string {
      return this.post?.image
        ? `https://eminegnc.github.io/${this.post?.image}`
        : `https://eminegnc.github.io/assets/images/posts/${this.post?.slug}.jpg`
    },
  },
})
</script>
