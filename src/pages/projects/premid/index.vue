    ...
    <div class="space-y-6 sm:w-9/12">
        ...
        <div class="space-y-1">
          ...
          <div class="space-y-2">
            ...
            <p class="text-gray-800 dark:text-gray-200">
              ...
              what you're doing on the web in your Discord now playing status.
            </p>
          </div>
        </div>
      </header>
      ...
      <section class="space-y-4">
        ...
        >
          <IconDev
            brand="premid"
            class="h-6 text-gray-800 w-6 dark:text-gray-200"
          />
  ...
  head() {
    ...
    return {
      ...
      meta: this.$prepareMeta({
        ...
        url: "https://emingenc.github.io/projects/premid",
      }),
      link: [
        {
          rel: "canonical",
